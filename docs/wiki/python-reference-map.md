...
| --- | --- | --- | --- |
| `open_mythos/main.py` | Core model, layers, recurrent loop, generation | `src/` core modules and model assembly | Highest |
| `open_mythos/tokenizer.py` | Hugging Face tokenizer wrapper | `src/tokenizer.jl` or a temporary Python bridge | High |
| `open_mythos/variants.py` | Named configuration presets | `src/variants.jl` | High |
