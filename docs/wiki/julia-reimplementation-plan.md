...
2. decide whether the remaining legacy OpenMythos Python FineWeb fallback can now be removed now that Julia-native local-parquet and remote rows-api paths exist,
