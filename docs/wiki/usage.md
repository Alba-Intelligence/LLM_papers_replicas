...
- the core model internals are still mostly manual Julia blocks, though `OpenMythos.jl` now also exposes the first Lux-native leaf-layer mirrors for attention, experts / MoE, and recurrent update primitives,
