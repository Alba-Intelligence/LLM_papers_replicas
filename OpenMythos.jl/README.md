...
- tokenizer parity through a Julia-native shared `TextDataCore.jl` BytePairEncoding / tiktoken-backed path,
...
For an optional remote FineWeb-Edu-backed smoke run through the Julia rows API path:
